...
class Report(Base):
    ...
    araq_score: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    araq_sec_a_score: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    araq_sec_b_score: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    araq_sec_c_score: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    araq_sec_d_score: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
